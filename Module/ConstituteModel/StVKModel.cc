...
DEFINE_CLONE(ConstituteModelParameter, StVKModelParameter)
...
void StVKModel::Initialize(const ConstituteModelParameter& para) {
...
DEFINE_CLONE(ConstituteModel, StVKModel)